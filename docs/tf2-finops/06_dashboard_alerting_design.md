...
- **Contract-Backed Status & Incident Detail Fields**: The UI exposes key parameters retrieved directly from the S3 Authoritative audit store (with read-caching in DynamoDB), representing the logical API contract v1.1 semantics:
