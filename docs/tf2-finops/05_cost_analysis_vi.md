...
| **Compute - AI Engine Request/Worker Lambdas** | $0.20/1M requests + $0.0000166667/GB-second | Hàm Lambda container AI Engine Request và worker chạy theo kích hoạt SQS; chu kỳ 24h | Chi phí host workload AI biến đổi; gắn tag riêng biệt khỏi CDO adapter. |
...
| AI Engine Lambda compute | `Cần bằng chứng: số lượt gọi và số GB-giây` | `Cần bằng chứng: báo cáo tag Cost Explorer` | `Cần bằng chứng` | Thời lượng thực thi hàm Lambda Request container và worker kích hoạt qua SQS. |
