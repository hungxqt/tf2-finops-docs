...
| **Provisioned Concurrency (Tùy chọn)** | $0.015/GB-second + $0.15/1M requests concurrency charges | Các môi trường thực thi được làm ấm sẵn cho AI Engine Request Lambda | Tối ưu hóa sản xuất tùy chọn; `Cần bằng chứng: lượng concurrency yêu cầu và số giờ làm ấm`. |
