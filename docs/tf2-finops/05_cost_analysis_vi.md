...
| **Storage - S3 raw/curated/idempotency** | $0.023/GB-month Standard, thấp hơn sau lifecycle | Kéo CUR/Cost Explorer, parquet chuẩn hóa, trích xuất dashboard, và đối tượng idempotency 24h | Biến đổi theo dung lượng dữ liệu hóa đơn. |
| **Storage - S3 authoritative audit** | $0.0125/GB-month ước tính IA | Containment và bằng chứng quyết định lưu trữ S3/Object Lock (lưu giữ ít nhất 90 ngày) | Biến đổi theo dung lượng cảnh báo/containment; việc lưu trữ là bắt buộc. |
| **Database - DynamoDB on-demand** | $1.25/triệu write + $0.25/triệu read | Bộ đệm cache chỉ đọc phục vụ dashboard | Biến đổi theo các lượt chạy và lượt đọc dashboard. |
...
- 7× VPC Interface Endpoints (Lambda, ECR, Logs, KMS, Secrets Manager, STS): $50.40 (với S3 và DynamoDB được cấu hình dưới dạng Gateway Endpoints miễn phí)
- 3× KMS CMKs: $3.00
