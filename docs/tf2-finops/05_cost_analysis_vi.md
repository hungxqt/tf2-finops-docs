...
| **Observability - CloudWatch & X-Ray** | Phí Logs, metrics, trace analyzer, và dashboard | Logs của Lambda, traces của Step Functions, metrics hàng đợi, và dashboard giám sát nền tảng | Dùng chung và biến đổi; có thể trở thành nhân tố dẫn đầu về chi phí. |
