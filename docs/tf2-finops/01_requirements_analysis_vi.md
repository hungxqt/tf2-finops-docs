...
| AI Engine hosting uptime | ≥99.5% availability cho các hàm hosted model | Hàm Lambda container AI Engine do CDO host phải đáng tin cậy cho các tác vụ gọi thực thi trực tiếp. |
