...
|---|---|---|
| `POST /v1/detect` | `ai-api-contract.md` | Bắt đầu phát hiện bất thường theo lô đồng bộ. CDO gọi Lambda phát hiện AI với dữ liệu chi phí, trả về `success`, `correlation_id`, `anomalies_detected`, và `anomalies_list`. |
...
| **Tính khả dụng hệ thống** | >=99.5% | Tính khả dụng toàn bộ của đường dẫn thực thi Lambda trực tiếp. |
