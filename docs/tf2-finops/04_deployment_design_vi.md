...
6. Xác thực hàm AI Engine Lambda trả về phản hồi đồng bộ 200 OK với chỉ thị thành công.
```
...
2. Kiểm tra JSON schema của API contract logic đầu vào và đầu ra tại endpoint `/v1/detect` của AI Engine cho việc gọi trực tiếp qua Lambda.
