...
* Các hàm Request/Worker Lambda container của AI Engine, ECR, SQS queues, và các role execution Lambda.
...
| Deploy workload | Lambda (Request/Worker)                       | Triển khai các hàm Lambda container bằng cách xuất bản version và alias.  |
...
| **Trace Analyzer** | AWS X-Ray | Tracing đường đi của request từ Step Functions, qua Request Lambda, đến SQS và thực thi của Worker Lambda. |
