...
- Dữ liệu chi phí thô và các chỉ số sử dụng CloudWatch từ S3.
...
- Kết quả phát hiện bất thường và giải thích được trả về đồng bộ cho bộ điều phối Step Functions.
